 ...
 */
public class CustomerForm extends RentalStoreForm<Customer> {
    ...
    public CustomerForm(CustomerListLogic customerListLogic) {
        ...
        save.addClickListener(event -> {
            if (currentCustomer != null) {
                ...
                viewLogic.saveItem(currentCustomer);
            }
        });
        ...
        delete.addClickListener(event -> {
            if (currentCustomer != null) {
                viewLogic.deleteItem(currentCustomer);
            }
        });
    ...
    public void editItem(Customer customer) {
        ...
        if(customer.isNewObject()) delete.setEnabled(false);
    }
}
