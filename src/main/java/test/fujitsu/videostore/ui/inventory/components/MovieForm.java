 ...
 * Movie form
 */
public class MovieForm extends RentalStoreForm<Movie> {
    ...
    public MovieForm(VideoStoreInventoryLogic videoStoreInventoryLogic) {
        ...
        save.addClickListener(event -> {
            if (currentMovie != null) {
                ...
                viewLogic.saveItem(currentMovie);
            }
        });
        ...
        delete.addClickListener(event -> {
            if (currentMovie != null) {
                viewLogic.deleteItem(currentMovie);
            }
        });
    ...
    public void editItem(Movie movie) {
        ...
        if(movie.isNewObject()) delete.setEnabled(false);
    }
